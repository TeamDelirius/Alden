  ...
  return (
    <>
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <InputField name="article_description" label="Article Description" />
        </Grid>
        <Grid item xs={6}>
          <InputField name="manufacture_ruling" label="Manufacture Ruling #" />
        </Grid>
        <Grid item xs={6}>
          <InputField name="manufacured_tin" label="Manufactured TIN" />
        </Grid>
