  ...
  return (
    <>
      <Grid container spacing={2}>
        ...
        <Grid item xs={2}>
          <InputField name="record_indicator" label=" " />
        </Grid>
        <Grid item xs={6}>
          <InputField name="cbp_personnel_badge" label="CBP Personnel Badge" />
        </Grid>
        <Grid item xs={6}>
          <InputField name="cbp_personnel_phone" label="CBP Personnel Phone" />
        </Grid>
        <Grid item xs={6}>
          <InputField name="processing_examination_date" label="Processing Examination Date" />
        </Grid>
        <Grid item xs={6}>
          <InputField name="name_of_cbp_personnel" label="Name of CBP Personnel" />
        </Grid>
