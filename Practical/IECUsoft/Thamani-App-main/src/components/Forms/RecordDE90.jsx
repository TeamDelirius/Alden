  ...
  return (
    <>
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <InputField name="grand_total_duty_amount" label="Grand Total Duty Amount" />
        </Grid>
        <Grid item xs={12}>
          <InputField name="grand_total_user_fee_amount" label="Grand Total User Fee Amount" />
        </Grid>
        <Grid item xs={12}>
          <InputField name="grand_total_ir_tax_amount" label="Grand Total IR Tax Amount" />
        </Grid>
